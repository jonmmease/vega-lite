...
export declare function parseLegend(model: Model): Partial<Record<"fill" | "stroke" | "angle" | "color" | "fillOpacity" | "opacity" | "strokeOpacity" | "strokeWidth" | "size" | "shape" | "strokeDash", LegendComponent>>;
